...
result.select(format_string('%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s',
              ...
              result.pickup_datetime, result.rate_code,
              result.store_and_fwd_flag, result.dropoff_datetime,
              result.passenger_count, result.trip_time_in_secs,
              result.trip_distance, result.pickup_longitude,
              result.pickup_latitude, result.dropoff_longitude,
              result.dropoff_latitude, result.payment_type,
